...
hooks:
  user_defines:
    executorch_dart:
      ...
      # prebuilt_version: "1.5.0.1" # Optional: pin a specific native release
...
| `prebuilt_version` | Current release (e.g. `1.5.0.1`) | Pin a specific prebuilt native release instead of this package version's default |
