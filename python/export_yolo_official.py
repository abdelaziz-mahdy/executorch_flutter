...
#
# Adapted for ExecuTorch Flutter project
# Original: https://github.com/pytorch/executorch/tree/main/examples/models/yolo12
...
# de_parallel compatibility function
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="yolo11n.pt",
        help="Ultralytics YOLO model name (e.g., yolov8n.pt, yolo11n.pt, yolo12n.pt)",
    )
    parser.add_argument(
        "--input_dims",
        type=eval,
    ...
    parser.add_argument(
        ...
        help="Select the Executorch inference backend (openvino, xnnpack). xnnpack by default for mobile.",
    )
    parser.add_argument(
        "--device",
        type=str,
